...
export function BottomNav({
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 z-40 border-t border-gray-200 dark:border-gray-700 bg-white/90 dark:bg-[#0b1220]/90 backdrop-blur">
      <div className="mx-auto max-w-[680px] px-4 h-14 grid grid-cols-4 items-center text-xs">
        {tabs.map(({ id, label, Icon }) => (
          <button
            ...
            className="flex flex-col items-center gap-0.5 text-gray-600 dark:text-gray-400 data-[active=true]:text-blue-600 dark:data-[active=true]:text-blue-400 data-[active=true]:shadow-lg data-[active=true]:shadow-blue-600/20 transition-colors py-1"
          >
        ...
        {user && (
          <div className="flex flex-col items-center gap-0.5 text-gray-600 dark:text-gray-400 py-1">
