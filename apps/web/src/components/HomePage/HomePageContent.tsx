...
export function HomePageContent({ realEvents }: HomePageContentProps) {
  ...
  console.log('📦 Mock event IDs:', mockFeed.map(e => e.kind === 'market' ? e.id : e.kind === 'group' ? e.groupId : 'unknown'));
  console.log('🔄 Real events count:', realEvents.length);
  console.log('🔄 Real event IDs:', realEvents.map(e => e.kind === 'market' ? e.id : e.kind === 'group' ? e.groupId : 'unknown'));
  console.log('🎯 Combined feed count:', feed.length);
  console.log('📋 Final event IDs:', feed.map(e => e.kind === 'market' ? e.id : e.kind === 'group' ? e.groupId : 'unknown'));
