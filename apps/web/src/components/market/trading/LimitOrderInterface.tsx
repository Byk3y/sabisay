...
export const LimitOrderInterface = ({
  ...
  const defaultPrice = selectedCandidate === 0 
  ...
  const limitWin = calculateLimitWin(currentShares, parseFloat(currentLimitPrice));
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <label className="text-sm md:text-base font-semibold text-gray-900 dark:text-gray-100">Limit Price</label>
      ...
      <div className="flex items-start justify-between">
        <label className="text-sm md:text-base font-semibold text-gray-900 dark:text-gray-100 mt-1 md:mt-2">Shares</label>
      ...
      <div>
        <div className="flex items-center justify-between py-2 md:py-3">
          <span className="text-sm md:text-base font-semibold text-gray-900 dark:text-gray-100">Set Expiration</span>
          <button
          ...
          >
            <span
              className={`inline-block h-3 w-3 md:h-4 md:w-4 transform rounded-full bg-white transition-transform ${
                expirationEnabled ? 'translate-x-5 md:translate-x-6' : 'translate-x-1'
              }`}
            />
          </button>
        </div>
        ...
        {expirationEnabled && (
          <div className="mt-2 relative">
            ...
            >
              <span className="text-sm md:text-base font-medium text-gray-900 dark:text-white">{selectedExpiration}</span>
              <svg className="w-4 h-4 md:w-5 md:h-5 text-gray-900 dark:text-white transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="absolute top-full left-0 right-0 mt-1 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 rounded-lg shadow-lg z-10">
              <div className="py-1 md:py-2">
                {expirationOptions.map((option) => (
                  ...
                  >
                    <span className="text-sm md:text-base font-medium text-gray-900 dark:text-white">{option}</span>
                  </button>
                ))}
              </div>
            </div>
      ...
      <div className="space-y-2 pt-2 border-t border-gray-200 dark:border-gray-700">
        <div className="flex items-center justify-between">
          <span className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100">Total</span>
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-1 md:gap-2">
            <span className="text-base md:text-lg font-semibold text-gray-900 dark:text-gray-100">To Win</span>
