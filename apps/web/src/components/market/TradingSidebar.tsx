...
export const TradingSidebar = ({
  ...
  const potentialWin = tradeAmount
    ? calculatePotentialWin(parseFloat(tradeAmount), currentPrice || 0)
    : 0;
  ...
  return (
    <div
      className={`
        ...
        w-[430px] ${isBinaryMarket ? (isMobile ? (orderType === 'limit' ? 'min-h-[500px]' : 'min-h-[418px]') : 'h-auto') : orderType === 'limit' ? 'min-h-[500px]' : 'min-h-[418px]'} md:w-[340px] md:h-[calc(100vh-200px)]
    ...
    >
      ...
      >
        ...
        <div className="flex-1 flex flex-col">
          ...
          {currentOutcome && (!isBinaryMarket || isMobile) && (
            <ProfileSection
              market={market}
          ...
          <div
            className={`hidden md:flex items-center justify-between ${!isBinaryMarket ? 'mb-6' : 'mb-4'}`}
          >
