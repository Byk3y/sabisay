 ...
 */
export const validateTradeAmount = (amount: string | number): { isValid: boolean; error?: string } => {
 ...
 * @returns Validation result with error message if invalid
 */
export const validateLimitPrice = (price: string | number): { isValid: boolean; error?: string } => {
 ...
 * @returns Validation result with error message if invalid
 */
export const validateShares = (shares: string | number): { isValid: boolean; error?: string } => {
 ...
 * @returns Validation result with error message if invalid
 */
export const validateCandidate = (candidate: number): { isValid: boolean; error?: string } => {
 ...
 * @returns Validation result with error message if invalid
 */
export const validateOutcome = (outcome: number, market: Market): { isValid: boolean; error?: string } => {
 ...
 * @returns Validation result with error message if invalid
 */
export const validateTradeData = (tradeData: TradeData, market: Market): { isValid: boolean; error?: string } => {
 ...
 * @returns Validation result with error message if invalid
 */
export const validateMarketTradeable = (market: Market): { isValid: boolean; error?: string } => {
